...
public class DataRow {
    ...
    /**
     * The message for a given proposal
     */
    public String message;

    /**
     * The number of likes for this proposal
     */
    public int numLikes;
     ...
     */
    DataRow(int id, String message, int numLikes, Timestamp datecreated) {
        mId = id;
        this.message = message;
        this.numLikes = numLikes;
        mCreated = datecreated;
    }
